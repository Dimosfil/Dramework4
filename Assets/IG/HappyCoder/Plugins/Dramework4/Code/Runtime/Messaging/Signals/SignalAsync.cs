...
namespace IG.HappyCoder.Plugins.Dramework4.Runtime.Messaging.Signals
{
    ...
    internal class SignalAsync
    {
        #region ================================ FIELDS

        private static Dictionary<string, SignalData> _signals;
        private static ConcurrentQueue<SignalData> _firedSignals;
        ...
        {
            Dispatcher.OnEarlyDestroy -= Dispose;
        ...
        private static void Initialize()
        {
            ...
            _signals = new Dictionary<string, SignalData>();
            _firedSignals = new ConcurrentQueue<SignalData>();
            _cts = new CancellationTokenSource();

            ProcessSignals().Forget();

            _isInitialized = true;
        }

        private static async UniTask ProcessSignals()
        {
            while (_cts.IsCancellationRequested == false)
            {
                while (_firedSignals.Count > 0)
                {
                    if (_firedSignals.TryDequeue(out var signal) == false) continue;

                    if (signal.HasListeners == false)
                    {
                        if (DW4.AppConfig.LogDispatcher)
                            DW4.LogError($"[Signal.Fire]: Signal, Name:«{signal.Name}» has no listeners. Unable to fire signal");
                        return;
                    }

                    if (DW4.AppConfig.LogDispatcher)
                        DW4.Log($"[Signal.Fire]: Signal, Name:«{signal.Name}» is fired");
    ...
    [SuppressMessage("ReSharper", "StaticMemberInGenericType")]
    [SuppressMessage("ReSharper", "ClassNeverInstantiated.Global")]
    internal class SignalAsync<T>
    {
        #region ================================ FIELDS

        private static Dictionary<string, SignalData<T>> _signals;
        private static ConcurrentQueue<SignalAsyncData<T>> _firedSignals;
        private static CancellationTokenSource _cts;
        ...
        internal static void Fire(T data)
        {
            GetSignal(_typeName, out var signal);
            var firedSignal = new SignalAsyncData<T>(signal, data);
            _firedSignals.Enqueue(firedSignal);
        }
        ...
        internal static void Subscribe(Action<T> callback, int order)
        {
            Subscribe(_typeName, callback, order);
        }
        ...
        {
            Unsubscribe(_typeName, callback);
        }
        ...
        private static void GetSignal(string name, out SignalData<T> signal)
        {
            if (_signals.TryGetValue(name, out signal)) return;
            signal = new SignalData<T>(name);
            _signals.Add(name, signal);
        }
        ...
        private static void Initialize()
        {
            ...
            _signals = new Dictionary<string, SignalData<T>>();
            _firedSignals = new ConcurrentQueue<SignalAsyncData<T>>();
            _cts = new CancellationTokenSource();
        ...
        private static async UniTask ProcessSignals()
        {
            while (_cts.IsCancellationRequested == false)
            {
                while (_firedSignals.Count > 0)
                {
                    if (_firedSignals.TryDequeue(out var firedSignal) == false) continue;

                    if (firedSignal.HasListeners == false)
                    {
                        if (DW4.AppConfig.LogDispatcher)
                            DW4.LogError($"[Signal.Fire]: Signal, Name:«{firedSignal.Name}» has no listeners. Unable to fire signal");
                        return;
                    }

                    if (DW4.AppConfig.LogDispatcher)
                        DW4.Log($"[Signal.Fire]: Signal, Name:«{firedSignal.Name}» is fired");
    ...
    [SuppressMessage("ReSharper", "StaticMemberInGenericType")]
    [SuppressMessage("ReSharper", "ClassNeverInstantiated.Global")]
    internal class SignalAsync<T1, T2>
    {
        #region ================================ FIELDS

        private static Dictionary<string, SignalData<T1, T2>> _signals;
        private static ConcurrentQueue<SignalAsyncData<T1, T2>> _firedSignals;
        private static CancellationTokenSource _cts;
        private static bool _isInitialized;
        ...
        {
            GetSignal(name, out var signal);
            var firedSignal = new SignalAsyncData<T1, T2>(signal, data1, data2);
            _firedSignals.Enqueue(firedSignal);
        }
        ...
        private static void GetSignal(string name, out SignalData<T1, T2> signal)
        {
            if (_signals.TryGetValue(name, out signal)) return;
            signal = new SignalData<T1, T2>(name);
            _signals.Add(name, signal);
        }
        ...
        private static void Initialize()
        {
            ...
            _signals = new Dictionary<string, SignalData<T1, T2>>();
            _firedSignals = new ConcurrentQueue<SignalAsyncData<T1, T2>>();
            _cts = new CancellationTokenSource();
    ...
    [SuppressMessage("ReSharper", "StaticMemberInGenericType")]
    [SuppressMessage("ReSharper", "ClassNeverInstantiated.Global")]
    internal class SignalAsync<T1, T2, T3>
    {
        #region ================================ FIELDS
    ...
    [SuppressMessage("ReSharper", "StaticMemberInGenericType")]
    [SuppressMessage("ReSharper", "ClassNeverInstantiated.Global")]
    internal class SignalAsync<T1, T2, T3, T4>
    {
        #region ================================ FIELDS
    ...
    [SuppressMessage("ReSharper", "StaticMemberInGenericType")]
    [SuppressMessage("ReSharper", "ClassNeverInstantiated.Global")]
    internal class SignalAsync<T1, T2, T3, T4, T5>
    {
        #region ================================ FIELDS
    ...
    [SuppressMessage("ReSharper", "StaticMemberInGenericType")]
    [SuppressMessage("ReSharper", "ClassNeverInstantiated.Global")]
    internal class SignalAsync<T1, T2, T3, T4, T5, T6>
    {
        #region ================================ FIELDS
    ...
    [SuppressMessage("ReSharper", "StaticMemberInGenericType")]
    [SuppressMessage("ReSharper", "ClassNeverInstantiated.Global")]
    internal class SignalAsync<T1, T2, T3, T4, T5, T6, T7>
    {
        #region ================================ FIELDS
    ...
    [SuppressMessage("ReSharper", "StaticMemberInGenericType")]
    [SuppressMessage("ReSharper", "ClassNeverInstantiated.Global")]
    internal class SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8>
    {
        #region ================================ FIELDS
    ...
    [SuppressMessage("ReSharper", "StaticMemberInGenericType")]
    [SuppressMessage("ReSharper", "ClassNeverInstantiated.Global")]
    internal class SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9>
    {
        #region ================================ FIELDS
    ...
    [SuppressMessage("ReSharper", "StaticMemberInGenericType")]
    [SuppressMessage("ReSharper", "ClassNeverInstantiated.Global")]
    internal class SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
    {
        #region ================================ FIELDS
