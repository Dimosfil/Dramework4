...
{
    public sealed class DWTestContainerDraft : IDisposable
    {
        private readonly List<Binding> _bindings = new List<Binding>();
        private readonly List<object> _trackedObjects = new List<object>();

        public DWTestContainerDraft Bind<T>(T instance, string id = "") where T : class
        {
            if (instance == null) throw new ArgumentNullException(nameof(instance));
            return Bind(typeof(T), instance, id);
        }

        public DWTestContainerDraft Bind(Type contractType, object instance, string id = "")
        {
        ...
        public DWTestContainerDraft Bind<TContract, TImplementation>(string id = "", bool asSingle = true)
        ...
        public DWTestContainerDraft Bind<TImplementation>(string id = "", bool asSingle = true)
